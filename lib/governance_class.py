...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to dinerod "gobject list" output
    ...
    def dinerod_serialise(self):
        import dinerolib
        return dinerolib.SHIM_serialise_for_dinerod(self.serialise())
