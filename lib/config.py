...
sentinel_cfg = DineroConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_dinerod_proto_version_with_sentinel_ping = 70207


def get_dinero_conf():
    home = os.environ.get('HOME')

    dinero_conf = os.path.join(home, ".dinerocore/dinero.conf")
    if sys.platform == 'darwin':
        dinero_conf = os.path.join(home, "Library/Application Support/DineroCore/dinero.conf")

    dinero_conf = sentinel_cfg.get('dinero_conf', dinero_conf)
